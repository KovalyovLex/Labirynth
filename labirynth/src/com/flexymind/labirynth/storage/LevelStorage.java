...
//[review] mandrigin: always remove autogenerated contents
//fill the "catch" block with something more accurate than printStackTrace()
...
//is better
	private GameLevel loadGameLevelfromxml(XmlResourceParser xml){
		...
		Wall twall = null;
		Ball tball = null;
//[review] mandrigin: do not initialize many values on one line!
//Bad names of variables 'x1', 'x2', 'y1',... proposed.
...
//[review] mandrigin: large if...elseif...else block -- refactor!
					deep = xml.getDepth();
					xml.next();
			...
			// TODO Auto-generated catch block
//[review] mandrigin: remove autogenerated comments here
			e.printStackTrace();
		} catch (IOException e) {
//[review] mandrigin: remove autogenerated comments here
			// TODO Auto-generated catch block
